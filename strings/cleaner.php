...
<html>
  <head>
    <meta charset="utf-8">
    <title>Cleaner.php </title>
    <link rel="stylesheet" href="layout.css" type="text/css">
  </head>
  <body>
    <?php
    $corrupted_file ="N3AmE,JO9b TitlE32s,Department,Full or= Pa+rt-Time,Salary or Hourly,Typi4>/>cal Hours,Annual Sal>ary,Hou)(rly Rate
    ...
    $string = $corrupted_file;
    $explode = explode(',',$string);
    $toparse = clean($explode);
    // print_r($toparse);
    echo "<h1 style='background:green','margin:auto';>String in Table Format</h1>";
    // table formating
    $chunked = array_chunk($toparse,8);
    $x = sizeof($chunked);
